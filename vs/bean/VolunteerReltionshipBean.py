 class VolunteerReltionshipBean(VolschedBeanBase:
    ...
    def availableTable(self):
        ...
        return multiColumnTableRows("Available Volunteers",
                ...
                size,
                vols,
volunteerJobRelationshipAdd.html",
                true)
    ...
    def autoAdd(self):
        ...
        try:
            ...
            if (vi is not None):
                ...
                result="volunteerRelationshipSearch.html"
                        + "?faces-redirect=true"
                        + "&volunteerID="
                        + vi.getID()
...
volunteerJobRelationshipDelrte.html"
                        + "?volunteerID=" + getVolunteer().getID(),
                true)
    ...
    def setRelationship(selfRelationshipImpl relationship):
        ...
        if (relationship is not None):
            ...
            self.vol2 = relationship.getVolunteerOneID().longValue() == getVolunteer().getID()
    ...
    def cancel(self):
        ...
        String extra = ""
        VolunteerImpl vi = getVolunteer()
        sessionData.pull(RequestType.relationship, true)
        if (vi is not None):
