 class VolunteerAvailabilityBean(VolschedBeanBase:
...
yyyy")
    ...
    def init(self):
        ...
        saveRequestParameters(RequestType.availability)
        loadAvailability()
    

     VolunteerAvailabilityBean():
    ...
    private voID loadAvailability():
        Long ID = None
        RequestParametersHolder rph = sessionData.pull(RequestType.volunteer, False)
        String idStr = rph.getAvailabilityID()
    ...
    def cancel(self):
        ...
        return "volunteerAvailabilities?faces-redirect=true" + extra
